...
class NivelController extends Controller
{
     ...
     *   @OA\Parameter( name="order_by", in="query", description="Campo para ordenação (id, nivel, desenvolvedores_count)", required=false, @OA\Schema(type="string", enum={"id", "nivel", "desenvolvedores_count"}, default="id") ),
